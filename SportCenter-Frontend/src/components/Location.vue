  ...
  <div class="solid-background">
    ...
    <div class="table">
      <table>
        ...
        <tr>
          <span v-if="createErrorLocation" class="error-message"
            >Error: {{ createErrorLocation }}</span
          >
        </tr>
        <tr>
...
export default {
  ...
  computed: {
    isCreateBtnDisabled() {
      return !this.newLocationFloor || !this.newLocationRoom;
    },
  },
};
</script>
