...
import ca.mcgill.ecse321.sportcenter.repository.AccountRepository;
...
public class SportCenterIntegrationTests {
    ...
    private Time valid_closing_time = Time.valueOf("00:00:00");
    ...
    private String new_valid_name = "J";
    ...
    private String new_valid_email = "j@mail.mcgill.ca";
